...
export function AuthNavigator() {
  ...
  useEffect(() => {
    ...
    const inProtectedArea = segments[0] === '(tabs)' || segments[0] === 'donation-tracker' || segments[0] === 'projects' || segments[0] === 'news' || segments[0] === 'admin' || segments[0] === 'events' || segments[0] === 'medina-baye-project' || segments[0] === 'resources' || segments[0] === 'compose-message' || segments[0] === 'marketplace';
